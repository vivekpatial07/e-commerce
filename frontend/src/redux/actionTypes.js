...
export const checkoutActions = {
  ...
  CHECK_ADDRESS_INIT: 'CHECK_ADDRESS_INIT',
  CHECK_ADDRESS_SUCC: 'CHECK_ADDRESS_SUCC'
}
...
export const merchantActions = {
  CREATE_PROD_INITIATE: 'CREATE_PROD_INITIATE',
  CREATE_PROD_FAIL: 'CREATE_PROD_FAIL',
  CREATE_PROD_SUCCESS: 'CREATE_PROD_SUCCESS',

  FETCH_MERCH_PROD_INIT: 'FETCH_MERCH_PROD_INIT',
  FETCH_MERCH_PROD_FAIL: 'FETCH_MERCH_PROD_FAIL',
  FETCH_MERCH_PROD_SUCCESS: 'FETCH_MERCH_PROD_SUCCESS'
}